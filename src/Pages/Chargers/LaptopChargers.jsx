  ...
  return (
    <div className="laptop-chargers-page">
      <div className="laptop-chargers-page__header">
        <span className="laptop-chargers-page__eyebrow">Chargers</span>
        <h1 className="laptop-chargers-page__title">Laptop Chargers</h1>
      ...
      <div className="laptop-chargers-page__inner">
        <div className="laptop-chargers-page__grid">
          {laptopchargersProducts.map(product => (
            <Link to={`/laptop-chargers/${product.id}`} key={product.id} style={{ textDecoration: 'none' }}>
