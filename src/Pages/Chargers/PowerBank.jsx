  ...
  return (
    <div className="powerbank-page">
      <div className="powerbank-page__header">
        <span className="powerbank-page__eyebrow">Power Banks</span>
        <h1 className="powerbank-page__title">Power Banks</h1>
      ...
      <div className="powerbank-page__inner">
        <div className="powerbank-page__grid">
          {powerbankProducts.map(product => (
            <Link to={`/powerbanks/${product.id}`} key={product.id} style={{ textDecoration: 'none' }}>
