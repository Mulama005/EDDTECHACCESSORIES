  ...
  return (
    <div className="laptop-page">
      <div className="laptop-page__header">
        <span className="laptop-page__eyebrow">Computing Collection</span>
        <h1 className="laptop-page__title">Laptops</h1>
      ...
      <div className="laptop-page__inner">
        <div className="laptop-page__grid">
          {laptopProducts.map(product => (
            <Link to={`/laptops/${product.id}`} key={product.id} style={{ textDecoration: 'none' }}>
