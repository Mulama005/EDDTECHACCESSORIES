  ...
  return (
    <div className="headphones-page">
      <div className="headphones-page__header">
        <span className="headphones-page__eyebrow">Audio Collection</span>
        <h1 className="headphones-page__title">Headphones</h1>
      ...
      <div className="headphones-page__inner">
        <div className="headphones-page__grid">
          {headphonesProducts.map(product => (
            <Link to={`/headphones/${product.id}`} key={product.id} style={{ textDecoration: 'none' }}>
